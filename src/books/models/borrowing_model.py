...
class BorrowingModel(BookModel):
    user = models.ForeignKey(UserModel, on_delete=models.CASCADE) # pour selection un utilisateur
    book = models.ForeignKey(BookModel, on_delete=models.CASCADE) # pour selection un livre
